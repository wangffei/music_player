...
<html>
  <head>
	...
	-->
	<script>var gedan_url = "${gedan_url}";</script>
	<style>
  ...
  <script>
 	var page = 1
  	$(function(){
  		$.ajax({
  			type:"GET",
  			url:"music.yy?method=gedan_temp&gedan_url="+gedan_url,
  			success:function(data){
  				...
  				for (var i=0;i<data.length;i++){
  		  			...
  		  			var music_name = $("<li></li>")
  		  				.append($("<a onclick='music_click(this)' href='javascript:void(0)' src='music.yy?method=music&music_url="+data[i].music_url+"'>"+data[i].music_name+"</a>"))
